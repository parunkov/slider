...
// describe('Модуль Model из массива', function() {
...
// 	it('Устанавливает tab из массива', function() {
// 		add();
// 		// model.data.isArray = true;
// 		// model.data.array = ['one', 'two', 'three', 'four'];
// 		// model.init();
// 		// model
// 		// expect().to
// 		model.setArrayValue();
// 		expect(model.tabText.min).toEqual('one');
// 		expect(model.tabText.max).toEqual('sss');
// 		remove();
// 	});
	// it('', function() {
	// 	add();
